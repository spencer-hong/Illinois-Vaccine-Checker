...
# I recommend creating a fake gmail to avoid spamming (and to avoid putting actual password in plain text)
...
while elapsed_time < max_total_runtime:
	...
	# 50km from 60202
	# this can be changed out --> the script will look for any zip codes that is in this list
	...
	print(f'You have checked the website {iterator} times. \n You have been running this script for {iterator * 5} minutes.')
	print('=================================')
	...
	if (full_vaccine_df.shape[0] != 0) and (available.shape[0] != 0):
		...
		print(f'None found. Will check again in 5 minutes.')
		print('=================================')
